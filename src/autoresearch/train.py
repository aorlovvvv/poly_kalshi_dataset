...
SIGNAL_SCALE = 1.50         # multiplier on raw signal before tanh
...
DIR_BLEND = 0.45            # weight on ML direction model (vs hand-crafted)
...
class TailRiskStrategy(Strategy):
    ...
    def size_position(self, tail_prob: float,
        ...
        threshold = 0.30 if is_entry else TURNOVER_THRESHOLD
        if delta < threshold:
